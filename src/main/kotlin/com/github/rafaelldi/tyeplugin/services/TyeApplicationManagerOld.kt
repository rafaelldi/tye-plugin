...
@Service
class TyeApplicationManagerOld(private val project: Project) {

    var isConnected: Boolean = false

    private val client: TyeApiClient = service()
    private val messageBus: MessageBus = project.messageBus
    private val application: TyeApplication = TyeApplication(null, null, null)
    private val log = Logger.getInstance(TyeApplicationManagerOld::class.java)
    ...
    private suspend fun updateApplication() {
        ...
        application.updateServices(services)
    }
    ...
    fun getServices(): List<com.github.rafaelldi.tyeplugin.model.TyeService> = application.getServices()
}
